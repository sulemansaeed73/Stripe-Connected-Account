...
import { fetchConnectedAccounts, ConnectedAccount } from "@/lib/api";
import ConnectedAccountsTable from "@/components/ConnectedAccountsTable";

type TabType = "all" | "transferred" | "connected-accounts";
...
export default function Dashboard() {
  ...
  const transferredTransactions = transactions.filter(
    (t) => t.connectedAccount !== null
  );
  const transferredCount = transferredTransactions.length;
  const transferredAmount = transferredTransactions.reduce(
    (sum, t) => sum + t.amount,
    0
  );
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
          ...
          <div className="p-6">
            {loading ? (
              ...
              <ConnectedAccountsTable accounts={connectedAccounts} />
            ) : (
